...
using ScaleControl = typename ScaleGroup::Control<void>;

template<typename Observer>
using ScaleTerminus = typename ScaleGroup::Terminus<Observer>;
...
using LinearScale =
    typename pex::ControlSelector<void>::template Type<ScaleRange>::Value;
